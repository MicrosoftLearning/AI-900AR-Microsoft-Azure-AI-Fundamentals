<div id="readme" class="Box-body readme blob js-code-block-container p-5 p-xl-6 gist-border-0" dir="rtl">
  ...
  <tbody>
  <tr>
  <td><div>تحليل الصور بالرؤية الحاسوبية</div></td>
  </tr>
  </tbody>
</table>
</div></td>
...
في هذا النشاط المعملي، سنستخدم خدمة الرؤية الحاسوبية في Azure لتحديد عناصر العالم الحقيقي بناءً على الصور.

-  افتح دفتر الملاحظات **01 - Image Analysis with Computer Vision.ipynb** في تعليمة Visual Studio برمجية. 
