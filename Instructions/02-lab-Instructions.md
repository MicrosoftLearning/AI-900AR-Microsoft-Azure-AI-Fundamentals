...
في هذا النشاط المعملي، سنستخدم خدمة الرؤية المخصصة في Azure لتحديد عنصر للعالم الحقيقي في صورة.

-  افتح دفتر ملاحظات **02 - Image Classification.ipynb** في تعليمة Visual Studio برمجية.
